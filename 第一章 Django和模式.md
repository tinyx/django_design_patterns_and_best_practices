...
尽管这个文档描述的是当初设计Django时的思路，它对开发者开发Django应用仍然非常有帮助。像**不要重复你自己(Don't Repeat Yourself, DRY)**，**低耦合**，**高聚合**等设计原则在你开发和维护Django应用的时候非常有用。
...
下一章，我们会看一看创建Django工程之初所需要的一些简单的步骤，比如掌握客户需求，创建一些小样例，设置好整个工程。